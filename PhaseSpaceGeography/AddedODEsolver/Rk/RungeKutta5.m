function Y = RungeKutta5(odefun,tspan,y0,varargin)
%RungeKutta5  Solve differential equations with a non-adaptive method of order 5.
%   Y = RungeKutta5(ODEFUN,TSPAN,Y0) with TSPAN = [T1, T2, T3, ... TN] integrates 
%   the system of differential equations y' = f(t,y) by stepping from T0 to 
%   T1 to TN. Function ODEFUN(T,Y) must return f(t,y) in a column vector.
%   The vector Y0 is the initial conditions at T0. Each row in the solution 
%   array Y corresponds to a time specified in TSPAN.
%
%   Y = RungeKutta5(ODEFUN,TSPAN,Y0,P1,P2...) passes the additional parameters 
