...
if (G_vec(1:10,1).^2+G_vec(1:10,2).^2) == 0;
    ...
    if strcmp(get(app.SingleFigures, 'Checked'),'on')
        figure
        plot(t, sm_ax)
        title('Semimajor axis \itvs \rmTime (standard method)','FontSize',12)
        xlabel('\rmt', 'FontSize',14), ylabel('\ita', 'FontSize',14)
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        figure
        plot(t, Ecc)
        title('Eccentricity \itvs \rmTime (standard method)','FontSize',12)
        xlabel('\rmt', 'FontSize',14), ylabel('\itE', 'FontSize',14)   
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        figure
        plot(t, omega)
        title('Argument of pericentre \itvs \rmTime (standard method)','FontSize',12)
        xlabel('\rmt', 'FontSize',14), ylabel('\omega   (degrees)', 'FontSize',14)
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        figure
        plot(t, f)
        title('True anomaly \itvs \rmTime (standard method)','FontSize',12)
        xlabel('\rmt', 'FontSize',14), ylabel('\itf   \rm(degrees)', 'FontSize',14)
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    title('Argument of pericentre','FontSize',8)
...
if strcmp(get(app.SingleFigures, 'Checked'),'on')
    ...
    figure
    plot(t, Omega)
    title('Longitude of the ascending node \itvs \rmTime (standard method)','FontSize',12)
    xlabel('\rmt', 'FontSize',14), ylabel('\Omega   (degrees)', 'FontSize',14)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    figure
    plot(t, omega)
    ...
    figure
    plot(t, incl)
    title('Inclination \itvs \rmTime (standard method)','FontSize',12)
    xlabel('\rmt', 'FontSize',14), ylabel('\itI   \rm(degrees)', 'FontSize',14)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    figure
    plot(t, f)
    title('True anomaly \itvs \rmTime (standard method)','FontSize',12)
