...
% Kper = 2*pi*x*Kp([x1 x2 x3],[y1 y2 y3], lambda, epsilon1, epsilon2, epsilon3, epsilon4, epsilon5, deg1, deg2, deg3, deg4, deg5, Hp1, Hp2, Hp3, Hp4, Hp5);
Kper = 2*pi*x*K;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
dKper_U4 = (2*pi*sin(2*pi*tau)*(y1*diff(K,y1)+y2*diff(K,y2)+y3*diff(K,y3))...     	
            -2*pi*sin(2*pi*tau)*K);     	
%     	
...
dKper_V4 = (-2*pi*cos(2*pi*tau)*(y1*diff(K,y1)+y2*diff(K,y2)+y3*diff(K,y3))...     	
            +2*pi*cos(2*pi*tau)*K);     	
%     	
dKper_G1 = 0;     	
dKper_G2 = 0;     	
