...
val73b= get(app.popupmenu_ODE,'Value');

val74 = get(app.popupmenu_planetFMI_ext,'Value');
...
val79 = get(app.popupmenu_planetFMI_int,'Value');
...
val113 = get(app.verbose,'Checked');

InitStr = struct('mass1',val1, 'mass2',val2, 'mass3',val3, 'mass4',val4,'mass5',val5, 'mass6',val6, 'mass7',val7, 'mass8',val8,'mass9',val9, 'mass10',val10,...
        ...
        'integstep',val71,'totint',val72,'outstep',val73,'ODE',val73b,...
        'planetFMI_ext',val74,'extfrom',val75,'extto',val76,'extstep',val77, 'action_ext',val78,...
        'planetFMI_int',val79,'intfrom',val80,'intto',val81,'intstep',val82, 'action_int',val83,...
        ...
        'View1',val109,'View2',val110,'View3',val111,'View4',val112,'Verbose',val113);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%